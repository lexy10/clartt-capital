"""Autopilot Monitor for the Execution Engine.

Monitors per-account autopilot state via Redis key and pub/sub channel.
When enabled for an account, signals are processed for trade execution;
when disabled, signals are discarded and the discard reason is logged.
